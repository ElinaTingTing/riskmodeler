...
# Parameter explain:
# Inputdata: the raw data you want fine binning 
...
class group_func():
    ...
    # The function is used for rough binning with decision tree method on fine grouped sample. The output is a data about which fine group belong to rough group.
    # Parameter explain:
